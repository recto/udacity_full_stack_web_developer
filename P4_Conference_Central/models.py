...
class SessionForm(messages.Message):
    ...
    startTime       = messages.StringField(7) # 24 hour notation.
...
class SessionTypeTimeForm(messages.Message):
    ...
    startTime       = messages.StringField(2) # 24 hour notation.

class FeaturedSpeakerForm(messages.Message):
    """FeaturedSpeakerForm -- FeaturedSpeaker outbound form message"""
...
class FeaturedSpeakerForms(messages.Message):
    """FeaturedSpeakerForms -- multiple FeaturedSpeakers outbound form message"""
    speakers = messages.MessageField(FeaturedSpeakerForm, 1, repeated=True)
